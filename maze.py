...
class Maze:
    ...
    def generate_maze(self):
        ...
        while break_count != len(self.grid_cells):
            ...
            self.solution_path.append(current_cell)  # Add the current cell to the solution path
    ...
    def solve_maze(self):
        ...
        while stack:
            ...
            neighbors = current_cell.get_neighbors(self.cols, self.rows, self.grid_cells)
